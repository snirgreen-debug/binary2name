...
echo "Welcome! This is an execution bash script for the coreutils results (assuming symbolic execution is already done)"
...
python3 run_pproc.py --output_dir coreutils --dataset_dir coreutils_ds --log_dir coreutils_logs --cpu_no 30 --mem_limit 1 --no_usables_file
